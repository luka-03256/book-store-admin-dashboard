...
import {CategoryDialogs} from "@/components/Categories/Dialogs/CategoryDialog";
...
export default function UsersPage() {
    ...
    const {
        ...
        error,
        fetchData
    } = useFetchCallback(`http://localhost:5287/Category/GetListPaginationDetails?PageNumber=${pageNumber}&PageSize=${pageSize}`);
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-md-6 d-flex justify-content-end">
                                <Link href={'/categories/create'} className={'btn btn-small btn-success'}>
                                    Create
