...
export const DeleteCategoryDialog = ({isOpen}) => {
    ...
    const {fetchData} = useFetchCallbackWithMethod(`http://localhost:5287/Category/Delete?id=${id}`, "DELETE");

    //http://localhost:5287/Category/Delete?id=661d1ed6695db92923cc6b27
